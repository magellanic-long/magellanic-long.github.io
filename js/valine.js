!(function (e, t) {
    ...
    return (function (e) {
                ...
                0 !== l &&
                    (l
                        ...
                        : ((s = new Promise(function (t, n) {
                          ...
                          (t.src = a.p + "MiniValine." + ({ 1: "visitor" }[(s = e)] || s) + ".min.js"),
                          (n = new Error()),
                          (r = function (a) {
                              ...
                              0 !== s &&
                                  (s &&
                                      ((r = a && ("load" === a.type ? "missing" : a.type)),
            ...
            var i = {
                on: function (e, t, n, a) {
                    for (var r = 0, o = (e = e.split(" ")).length; r < o; r++)
                        i.off(e[r], t, n, a), t.addEventListener ? t.addEventListener(e[r], n, a || !1) : t.attachEvent ? t.attachEvent("on".concat(e[r]), n) : (t["on".concat(e[r])] = n);
                },
        ...
        function (e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", { value: !0 }),
                ...
                (t.EUrl = [
                    ...
                    "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN@master/HONKAI3-Durandal-Search",	
                    "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN@master/HONKAI3-MEI",	
                    "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN@master/HONKAI3-NEWYEAR-2019",	
                    "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN@master/HONKAI3-Pure",	
                    "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN@master/HONKAI3-Stan",	
                    "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN@master/HONKAI3-Star",
                    "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN@master/HONKAI3-AIChan",
                    "https://cdn.jsdelivr.net/gh/GamerNoTitle/ValineCDN@master/KeQing",
                    ...
                    // "https://cdn.jsdelivr.net/gh/magellanic-long/qq@latest",
                ]),
                ...
                (t.MaxNL = 6),
                (t.PS = 6),
                (t.C = { ip: "", comment: "", rid: "", pid: "", at: "", nick: "", mail: "", mailMd5: "", link: "", ua: navigator.userAgent, url: location.pathname });
        },
        function (e, t, n) {
            "use strict";
            var i = function (e) {
        ...
        function (e, t, n) {
            ...
            e.exports = function (e, t) {
                try {
                    ...
                    return 0 !== (n = Math.floor(a / 864e5))
                        ? n < 0
                            ? t.now
                            : n < 365
                            ? "".concat(n, " ").concat(t.days)
                            : i(e)
                        : ((n = a % 864e5),
                          0 !== (a = Math.floor(n / 36e5))
                              ? "".concat(a, " ").concat(t.hours)
                              : ((a = n % 36e5), 0 !== (n = Math.floor(a / 6e4)) ? "".concat(n, " ").concat(t.minutes) : ((a %= 6e4), 0 === (a = Math.round(a / 1e3)) ? t.now : "".concat(a, " ").concat(t.seconds))));
                } catch (e) {
                    console.log(e);
                }
            };
        ...
        function (e, t, n) {
            "use strict";
            var i,
                a = (i = n(39)) && i.__esModule ? i : { default: i };
            e.exports = function (e, t, n) {
        ...
        function (e, t, n) {
            "use strict";
            var i,
                a = (i = n(11)) && i.__esModule ? i : { default: i },
                r = n(1),
                o = function (e) {
        ...
        function (e, t, n) {
            ...
            e.exports = { item: i.default, loading: a.default, smiles: r.default, el: o.default, ele: n.default };
        },
        function (e, t, n) {
            "use strict";
            var i,
            ...
            e.exports = function (e, t) {
                ...
                if (o && !e.config.closeUA) {
                    o = UAParser(o);
                    try {
                        o.browser && o.browser.name
                            ? ((s += '<span class="system"><i class="ic i-'),
                              (n = o.browser.name.toLowerCase()),
                              ["samsung browser"].includes(n)
                                  ? (s += "mobile-alt")
                                  : ["android browser"].includes(n)
                                  ? (s += "android")
                                  : ["mobile safari", "safari"].includes(n)
                                  ? (s += "safari")
                                  : ["ie", "iemobile"].includes(n)
                                  ? (s += "internet-explorer")
                                  : ["wechat"].includes(n)
                                  ? (s += "weixin")
                                  : ["qqbrowser", "qqbrowserlite", "qq"].includes(n)
                                  ? (s += "qq")
                                  : ["baiduboxapp", "baidu"].includes(n)
                                  ? (s += "paw")
                                  : ["chrome", "chromium", "chrome headless", "chrome webview"].includes(n)
                                  ? (s += "chrome")
                                  : ["opera mobi", "opera", "opera coast", "opera mini", "opera tablet"].includes(n)
                                  ? (s += "opera")
                                  : ["firefox", "edge"].includes(n)
                                  ? (s += n)
                                  : (s += "snapchat-ghost"),
                              (s += '"></i><span>' + o.browser.name + " " + (o.browser.version ? o.browser.version : "") + "</span></span> "))
                            : (s += '<span class="system"><i class="ic i-stars"></i><span>Magical APP</span></span>'),
                            o.os && o.os.name
                                ? ((s += '<span class="system"><i class="ic i-'),
                                  (n = o.os.name.toLowerCase()),
                                  ["mac os", "ios"].includes(n)
                                      ? (s += "apple")
                                      : ["chromium os"].includes(n)
                                      ? (s += "chrome")
                                      : ["firefox os"].includes(n)
                                      ? (s += "firefox")
                                      : ["windows phone", "windows"].includes(n)
                                      ? (s += "windows")
                                      : ["android", "linux", "ubuntu", "suse", "redhat", "fedora", "centos", "blackberry"].includes(n)
                                      ? (s += n)
                                      : (s += "snapchat-ghost"),
                                  (s += '"></i><span>' + o.os.name + " " + (o.os.version ? o.os.version : "") + "</span></span>"))
                                : (s += '<span class="system"><i class="ic i-magic"></i><span>Magical OS</span></span>');
                    } catch (e) {}
                }
                var c = "";
                ...
                if (!e.config.closeFlag && e.config.cloudflag)
                    try {
                        ...
                        c = (f = e.cloudFlag.Users[f])
                            ? '<span class="tag" style="background:' +
                              "".concat(e.cloudFlag.Roles[f] && e.cloudFlag.Roles[f].color ? e.cloudFlag.Roles[f].color : "#6cf") +
                              ';">' +
                              "".concat(e.cloudFlag.Roles[f] && e.cloudFlag.Roles[f].nick ? e.cloudFlag.Roles[f].nick : "visitor") +
                              "</span>"
                            : '<span class="tag" style="background:' + "".concat(d.visitor && d.visitor.color ? d.visitor.color : "#828282") + ';">' + "".concat(d.visitor && d.visitor.nick ? d.visitor.nick : "visitor") + "</span>";
                    } catch (e) {}
                return (
                    '<img class="avatar" data-src="'.concat(i, '"/>') +
                    '<div class="main"><div class="head" >' +
                    "".concat(t.get("link") ? '<a class="name" href="'.concat(t.get("link"), '" target="_blank" rel="nofollow" >').concat(t.get("nick"), "</a>") : '<span class="name">'.concat(t.get("nick"), "</span>")) +
                    "".concat(c).concat(s, "</div>") +
                    '<div class="meta">' +
                    "<a"
                        .concat(t.get("rid") ? ' rid="'.concat(t.get("rid"), '"') : ' rid="'.concat(t.id, '"'), " at='@")
                        .concat(t.get("nick"), '\' class="at" id="at-')
                        .concat(t.id, '">')
                        .concat(e.i18n.reply, "</a>") +
                    '<span class="time">'.concat((0, r.default)(t.get("createdAt"), e.i18n), "</span>") +
                    "</div>" +
                    '<section class="content" id="comment-'.concat(t.id, '">') +
                    '<div class="inner md">'.concat(t.get("comment"), "</div>") +
                    '</section><div class="children">' +
                    '<ul class="list" id="children-'.concat(t.id, '"></ul>') +
                    "</div></div>"
                );
            };
        },
        ...
        function (e, t, n) {
            "use strict";
            var i,
                a = (i = n(17)) && i.__esModule ? i : { default: i };
            e.exports = function (e) {
                ...
                for (
                    var e = (function () {
                            ...
                            if ("TEXTAREA" === e.tagName || ("INPUT" === e.tagName && ("text" === e.getAttribute("type") || "email" === e.getAttribute("type")))) {
                                ...
                                return { x: t.left + i.left, y: t.top + i.top, color: l() };
                            }
                            return (e = window.getSelection()).rangeCount
                                ? ((t = e.getRangeAt(0)), (e = t.startContainer).nodeType === document.TEXT_NODE && (e = e.parentNode), { x: (i = t.getBoundingClientRect()).left, y: i.top, color: l() })
                                : { x: 0, y: 0, color: "transparent" };
                        })(),
                        t = 5 + Math.round(10 * Math.random());
                    t--;
        ...
        function (e, t, n) {
            ...
            function i(e, t, n) {
                ...
                return (
                    ...
                    n.appendChild(c),
                    (t = { top: c.offsetTop + parseInt(s.borderTopWidth), left: c.offsetLeft + parseInt(s.borderLeftWidth) }),
        ...
        function (e, t, n) {
            "use strict";
            var i,
                a = (i = n(20)) && i.__esModule ? i : { default: i };
            e.exports = function (e) {
                return (
                    '<div id="input"><div class="form">' +
                    ...
                    '<div class="input"><input type="text" name="author" class="vnick" placeholder="'.concat(e.i18n.nick, '" value=""></div>') +
                    '<div class="input"><input type="email" name="email" class="vmail" placeholder="'.concat(e.i18n.mail, '" value=""></div>') +
                    '<div class="input"><input type="text" name="website" class="vlink" placeholder="'.concat(e.i18n.link, '" value=""></div>') +
                    '</section><div class="textarea">' +
                    '<textarea placeholder="'.concat(e.placeholder, '" class="veditor"></textarea>') +
                    ...
                    '<i class="ic i-markdown"></i></a></div><div class="right"><div class="emojis btn" title="'.concat(e.i18n.emoji, '">') +
                    '<i class="ic i-smile"></i></div>' +
                    '<div class="preview btn" title="'.concat(e.i18n.preview, '">') +
                    '<i class="ic i-preview"></i></div>' +
                    '<button type="button" title="Cmd|Ctrl+Enter" class="vsubmit button">'.concat(e.i18n.submit, "</button>") +
                    ...
                    '<div class="col"> '.concat((0, a.default)(e.i18n.commentCount, '<span class="count">0</span>'), "</div>") +
        ...
        function (module, exports, __webpack_require__) {
            ...
            var i18n = function i18n(root) {
                var s;
                window.MV.i18n
                    ? ((root.i18n = window.MV.i18n), (window.MV.getI18n = 0))
                    : ((s = localStorage && localStorage.getItem("_ValineI18n")),
                      s ? ((s = JSON.parse(s)), s.lang == root.lang ? ((root.i18n = s.i18n), (window.MV.i18n = root.i18n), (window.MV.getI18n = 0)) : (window.MV.getI18n = 1)) : (window.MV.getI18n = 1),
                      window.MV.getI18n &&
                          (0, _ajax2.default)({
                              url: _Default.i18nUrl + root.lang + "/index.json",
                              type: "GET",
                              success: function success(data) {
                                  (data = eval("(" + data + ")")), (root.i18n = data), (window.MV.i18n = root.i18n), localStorage && localStorage.setItem("_ValineI18n", JSON.stringify({ lang: root.lang, i18n: root.i18n }));
                              },
                          }));
            };
            module.exports = i18n;
        ...
        function (e, t, n) {
            ...
            e.exports = function (e) {
                ...
                try {
                    window.MV.AVInit || AV.init({ appId: e.config.appId, appKey: e.config.appKey, serverURLs: t }), (window.MV.AVInit = !0);
                } catch (e) {}
                e.v = AV;
            };
        },
        function (module, exports, __webpack_require__) {
            ...
            var smile = function (e) {
                    if (((window.MV.emoticonUrl = e.emoticonUrl), window.MV.emoticonList)) (e.emoticonList = window.MV.emoticonList), (e.emoticon = window.MV.emoticon);
                        ...
                        setTimeout(function () {
                            localStorage && localStorage.setItem("_ValineSmile", JSON.stringify({ emoticonUrl: window.MV.emoticonUrl, emoticonList: window.MV.emoticonList }));
                        }, 5e3);
                    }
                },
            ...
            e.exports = function (e) {
                ...
                1 < arguments.length && void 0 !== arguments[1] && arguments[1]
                    ? ((t = []),
                      ...
                      (0, i.default)(
                          "https://cdn.jsdelivr.net/combine/" + t.join(","),
                          function () {
                              e.initBody(), (window.MV.scriptEle = !0);
                          },
                          1 == window.MV.scriptEle || 0 == t.length
                      ))
                    : (e.config.NoRecordIP || (void 0 === window.MV.ip ? (0, a.default)(e) : (e.C.ip = window.MV.ip)),
                      (t = []),
        ...
        function (e, t, n) {
            ...
            e.exports = function (e) {
                ...
                i.default.on("click", t, function (t) {
                    ...
                    void 0 !== (t = t.target.src) &&
                        ((t = "!(:".concat(decodeURI(t).replace(/^.*\/(.*)$/, "$1"), ":)")), (0, a.default)(n, t), (e.C.comment = n.value), (n = e.el.querySelector(".vsubmit")).getAttribute("disabled") && n.removeAttribute("disabled"));
                });
            };
        },
        function (e, t, n) {
            "use strict";
            var i,
                a = (i = n(8)) && i.__esModule ? i : { default: i };
            e.exports = function (e) {
                var t = e.el.querySelector(".smile-icons"),
                ...
                e.reset = function () {
                    ...
                    (e.C.rid = ""),
                        (e.C.nick = ""),
                        (e.C.at = ""),
                        ((e.el.querySelector(".form textarea").placeholder = ""), a.default)(e),
                        e.previewEvt(e),
        ...
        function (e, t, n) {
            ...
            e.exports = function (e) {
                ...
                a.default.on("click", t, function (e) {
                    i.getAttribute("triggered") && (i.setAttribute("style", "display:none;"), i.removeAttribute("triggered"), n.classList.remove("actived")),
                        r.getAttribute("triggered")
                            ? (r.setAttribute("style", "display:none;"), r.removeAttribute("triggered"), t.classList.remove("actived"))
        ...
        function (e, t, n) {
            ...
            e.exports = function (e) {
                ...
                a.default.on("click", t, function (a) {
                    if ((r.getAttribute("triggered") && (r.setAttribute("style", "display:none;"), r.removeAttribute("triggered"), n.classList.remove("actived")), i.getAttribute("triggered")))
                        i.setAttribute("style", "display:none;"), i.removeAttribute("triggered"), t.classList.remove("actived");
                    else {
        ...
        function (e, t, n) {
            ...
            var i,
                a = (i = n(0)) && i.__esModule ? i : { default: i };
            e.exports = function (e) {
                for (var t in ((e.inputs = {}), (e.mapping = { veditor: "comment", vnick: "nick", vlink: "link", vmail: "mail" }), e.mapping))
            ...
            e.exports = function (e) {
                ...
                e.submitEvt = function (i) {
                    ...
                    t.getAttribute("disabled")
                        ? e.alert.show({ type: 0, text: e.i18n.wait + 'ヾ(๑╹◡╹)ﾉ"', ctxt: e.i18n.ok })
                        : "" !== e.C.comment
                        ? "" !== e.C.nick
                            ? ((o = function (e) {
                                  (e.C.comment = e.TEXT),
                                      "" !== e.C.at &&
                                          ((i = '<a class="at" href=\'#'.concat(e.C.pid, "'>").concat(e.C.at, "</a>")),
                                  ...
                                  (e.C.mail = t.k ? t.v : ""), (e.C.link = i.k ? i.v : ""), (e.C.mailMd5 = md5(e.C.mail)), t.k && i.k ? n() : e.alert.show({ type: 0, text: e.i18n.inputTips, ctxt: e.i18n.confirm });
                              }),
                              (0, a.default)(e, e, o))
                            : e.inputs.nick.focus()
                ...
                var n = function () {
                    ...
                    var n,
                        i,
                        a = new (e.v.Object.extend("Comment"))();
                    ...
                    a.setACL(
                        ...
                        a
                            .save()
                            .then(function (n) {
                                localStorage && localStorage.setItem("_ValineCache", JSON.stringify({ nick: e.C.nick, link: e.C.link, mail: e.C.mail }));
                                var i = e.el.querySelector(".count");
                                (i.innerText = Number(i.innerText) + 1),
                                    "" === e.C.rid ? e.insertComment(n, null, !0) : ((i = e.el.querySelector("#children-".concat(e.C.rid))), e.insertComment(n, i, !1)),
        ...
        function (e, t, n) {
            "use strict";
            var i,
                a = (i = n(3)) && i.__esModule ? i : { default: i },
                r = n(40);
            e.exports = function (e, t, n) {
        ...
        function (e, t, n) {
            ...
            var i,
                a = (i = n(41)) && i.__esModule ? i : { default: i };
        },
        function (e, t, n) {
            "use strict";
            var i = n(42);
        ...
        function (e, t) {
            ...
            var v = Object.freeze({
                            ...
                            (function e(n, i) {
                                for (var a = n.firstChild; a; a = a.nextSibling)
                                    3 === a.nodeType
                                        ...
                                        : 1 === a.nodeType && (t.push({ event: "start", offset: i, node: a }), (i = e(a, i)), m(a).match(/br|hr|img|input/) || t.push({ event: "stop", offset: i, node: a }));
                                return i;
                            })(e, 0),
                            t
                        );
                ...
                y = (function () {
                    function e() {
                        c(this, e), (this.rootNode = { children: [] }), (this.stack = [this.rootNode]);
                    }
                    return (
                        u(
                            e,
                            [
                                ...
                                },
                                {
                                    key: "openNode",
                                    value: function (e) {
                                        (e = { kind: e, children: [] }), this.add(e), this.stack.push(e);
                                    },
                                },
                                {
                                    key: "closeNode",
            ...
            var E = "[a-zA-Z]\\w*",
                ...
                T = function (e, t) {
                    return (
                        (t = p({ className: "comment", begin: e, end: t, contains: [] }, 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {})).contains.push(k),
                        t.contains.push({ className: "doctag", begin: "(?:TODO|FIXME|NOTE|BUG|OPTIMIZE|HACK|XXX):", relevance: 0 }),
                        t
                    );
                },
                R = T("//", "$"),
                L = T("/\\*", "\\*/"),
                I = T("#", "$"),
                j = { className: "number", begin: x, relevance: 0 },
                D = { className: "number", begin: S, relevance: 0 },
                P = { className: "number", begin: C, relevance: 0 },
                B = { className: "number", begin: x + "(%|em|ex|ch|rem|vw|vh|vmin|vmax|cm|mm|in|pt|pc|px|deg|grad|rad|turn|s|ms|Hz|kHz|dpi|dpcm|dppx)?", relevance: 0 },
                q = { begin: /(?=\/[^/\n]*\/)/, contains: [{ className: "regexp", begin: /\//, end: /\/[gimuy]*/, illegal: /\n/, contains: [N, { begin: /\[/, end: /\]/, relevance: 0, contains: [N] }] }] },
                U = { className: "title", begin: E, relevance: 0 },
                z = { className: "title", begin: M, relevance: 0 },
                V = { begin: "\\.\\s*" + M, relevance: 0 },
                H = Object.freeze({
                    __proto__: null,
                    IDENT_RE: E,
            ...
            function K(e) {
                ...
                return (function i(a, s) {
                    ...
                    var l,
                        u = null;
                    if (
                        ("object" === d(a.keywords) && ((u = a.keywords.$pattern), delete a.keywords.$pattern),
                        a.keywords &&
                    ...
                    return (
                        (c.keywordPatternRe = t(a.lexemes || u || /\w+/, !0)),
                        s &&
                            (a.beginKeywords && ((a.begin = "\\b(" + a.beginKeywords.split(" ").join("|") + ")(?=\\b|\\s)"), (a.__beforeBegin = o)),
                            a.begin || (a.begin = /\B|\b/),
                            (c.beginRe = t(a.begin)),
                                    ...
                                    return (function (e) {
                                        return (
                                            ...
                                            e.cached_variants
                                                ...
                                                ? p(e, { starts: e.starts ? p(e.starts) : null })
                                                : Object.isFrozen(e)
                                                ? p(e)
                                                : e
                                        );
                        ...
                        (c.matcher =
                            ...
                            s.contains.forEach(function (e) {
                                return l.addRule(e.begin, { rule: e, type: "begin" });
                            }),
                            s.terminator_end && l.addRule(s.terminator_end, { type: "end" }),
                        ...
                        highlighted: function () {
                            return this.autoDetect || hljs.getLanguage(this.language)
                                ? (this.autoDetect
                                  ...
                                  e.value)
                                : (console.warn('The language "'.concat(this.language, '" you specified could not be found.')), (this.unknownLanguage = !0), g(this.code));
                            var e;
                        },
                        autoDetect: function () {
            ...
            v = (function (e) {
                var t = [],
                    ...
                    u = { noHighlightRe: /^(no-?highlight)$/i, languageDetectRe: /\blang(?:uage)?-([\w-]+)\b/i, classPrefix: "hljs-", tabReplace: null, useBR: !1, languages: null, __emitter: w };
                function g(e) {
                    return u.noHighlightRe.test(e);
                }
                function p(e, t, n, i) {
                    return S("before:highlight", (e = { code: t, language: e })), ((i = e.result ? e.result : m(e.language, e.code, n, i)).code = e.code), S("after:highlight", i), i;
                }
                function m(e, t, a, r) {
                    var s = t;
                    function l() {
                        if (w.keywords) {
                            ...
                            for (var t = w.keywordPatternRe.exec(x), n = ""; t; ) {
                                ...
                                var a,
                                    r = ((r = w), (a = t), (a = b.case_insensitive ? a[0].toLowerCase() : a[0]), Object.prototype.hasOwnProperty.call(r.keywords, a) && r.keywords[a]);
                    ...
                    function g(e) {
                        return e.className && M.openNode(e.className), (w = Object.create(e, { parent: { value: w } }));
                    }
                    var p = {};
                    function h(t, n) {
                        var i = n && n[0];
                        ...
                        if ("begin" === (p = n).type)
                            return (function (e) {
                                ...
                                return (
                                    ...
                                    n.skip ? (x += t) : (n.excludeBegin && (x += t), d(), n.returnBegin || n.excludeBegin || (x = t)),
                                    g(n),
                        ...
                        if (
                            ...
                            (r = (function (e) {
                                var t = e[0],
                                    ...
                                    i = (function e(t, n, i) {
                                        var a,
                                            r = ((a = i), (a = (r = t.endRe) && r.exec(a)) && 0 === a.index);
                                ...
                                if (!i) return W;
                                for (
                                    (n = w).skip ? (x += t) : (n.returnEnd || n.excludeEnd || (x += t), d(), n.excludeEnd && (x = t));
                                    w.className && M.closeNode(), w.skip || w.subLanguage || (S += w.relevance), (w = w.parent) !== i.parent;
                    ...
                    try {
                        ...
                        return h(s.substr(C)), M.closeAllNodes(), M.finalize(), (y = M.toHTML()), { relevance: S, value: y, language: e, illegal: !1, emitter: M, top: w };
                    } catch (t) {
                        if (t.message && t.message.includes("Illegal")) return { illegal: !0, illegalBy: { msg: t.message, context: s.slice(C - 100, C + 100), mode: t.mode }, sofar: y, relevance: 0, value: X(s), emitter: M };
                        if (o) return { illegal: !1, relevance: 0, value: X(s), emitter: M, language: e, top: w, errorRaised: t };
                        throw t;
                    }
                }
                function v(e, t) {
                    ...
                    var i,
                        a,
                        r = ((i = e), (a = { relevance: 0, emitter: new u.__emitter(u), value: X(i), illegal: !1, top: l }).emitter.addText(i), a),
                        o = r;
                    return (
                        t
                            .filter(E)
                ...
                function b(e) {
                    ...
                    g(o) ||
                        (S("before:highlightBlock", { block: e, language: o }),
                        u.useBR ? ((r = document.createElement("div")).innerHTML = e.innerHTML.replace(/\n/g, "").replace(/<br[ /]*>/g, "\n")) : (r = e),
                        (i = r.textContent),
                        (t = o ? p(o, i, !0) : v(i)),
                        (r = J(r)).length && (((n = document.createElement("div")).innerHTML = t.value), (t.value = Z(r, J(n), i))),
                        (t.value = h(t.value)),
                        S("after:highlightBlock", { block: e, result: t }),
                        (e.innerHTML = t.value),
                        (e.className = ((n = e.className), (i = o), (o = t.language), (i = i ? a[i] : o), (o = [n.trim()]), n.match(/\bhljs\b/) || o.push("hljs"), n.includes(i) || o.push(i), o.join(" ").trim())),
                        (e.result = { language: t.language, re: t.relevance, relavance: t.relevance }),
                        t.second_best && (e.second_best = { language: t.second_best.language, re: t.second_best.relevance, relavance: t.second_best.relevance }));
                }
                var y,
                    _ = function e() {
                        var n;
                ...
                for (y in (Object.assign(e, {
                    ...
                    registerLanguage: function (t, i) {
                        ...
                        a.name || (a.name = t), ((n[t] = a).rawDefinition = i.bind(null, e)), a.aliases && M(a.aliases, { languageName: t });
                    },
                            ...
                            return (
                                Object.getOwnPropertyNames(t).forEach(function (i) {
                                    !Object.hasOwnProperty.call(t, i) ||
                                        null === t[i] ||
                                        ("object" !== d(t[i]) && "function" != typeof t[i]) ||
                                        (n && ("caller" === i || "callee" === i || "arguments" === i)) ||
                                        Object.isFrozen(t[i]) ||
                                        e(t[i]);
                                }),
                                t
        ...
        function (e, t) {
            e.exports = function (e) {
                ...
                return {
                    ...
                    case_insensitive: !0,
                    contains: [
                        { className: "meta", begin: "<![a-z]", end: ">", relevance: 10, contains: [n, r, a, i, { begin: "\\[", end: "\\]", contains: [{ className: "meta", begin: "<![a-z]", end: ">", contains: [n, i, r, a] }] }] },
        ...
        function (e, t) {
            e.exports = function (e) {
                var t = { literal: "true false null" },
                    ...
                    a = { end: ",", endsWithParent: !0, excludeEnd: !0, contains: i, keywords: t },
                    r = { begin: "{", end: "}", contains: [{ className: "attr", begin: /"/, end: /"/, contains: [e.BACKSLASH_ESCAPE], illegal: "\\n" }, e.inherit(a, { begin: /:/ })].concat(n), illegal: "\\S" };
                a = { begin: "\\[", end: "\\]", contains: [e.inherit(a)], illegal: "\\S" };
                return (
                    i.push(r, a),
        ...
        function (e, t) {
            e.exports = function (e) {
                ...
                var i = { className: "subst", begin: /\$\(/, end: /\)/, contains: [e.BACKSLASH_ESCAPE] },
                    a = { className: "string", begin: /"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, t, i] };
                i.contains.push(a);
                var r = { begin: /\$\(\(/, end: /\)\)/, contains: [{ begin: /\d+#[0-9a-f]+/, className: "number" }, e.NUMBER_MODE, t] };
                (n = e.SHEBANG({ binary: "(".concat(["fish", "bash", "zsh", "sh", "csh", "ksh", "tcsh", "dash", "scsh"].join("|"), ")"), relevance: 10 })),
                    (i = { className: "function", begin: /\w[\w\d_]*\s*\(\s*\)\s*\{/, returnBegin: !0, contains: [e.inherit(e.TITLE_MODE, { begin: /\w[\w\d_]*/ })], relevance: 0 });
                return {
                    name: "Bash",
                    aliases: ["sh", "zsh"],
                    keywords: {
                    ...
                    contains: [n, e.SHEBANG(), i, r, e.HASH_COMMENT_MODE, a, { className: "", begin: /\\"/ }, { className: "string", begin: /'/, end: /'/ }, t],
                };
            };
        },
        function (e, t) {
            ...
            e.exports = function (e) {
                ...
                return {
                    ...
                    contains: [
                        ...
                        { begin: e.UNDERSCORE_IDENT_RE + "\\s", end: ";|{", returnBegin: !0, contains: [{ className: "attribute", begin: e.UNDERSCORE_IDENT_RE, starts: t }], relevance: 0 },
                    ],
                    illegal: "[^\\s\\}]",
                };
            };
            ...
            e.exports = function (e) {
                var t = {
                    ...
                    r = {
                        ...
                        variants: [
                            ...
                            { begin: /(u|b)?r?"""/, end: /"""/, contains: [e.BACKSLASH_ESCAPE, n], relevance: 10 },
                            { begin: /(fr|rf|f)'''/, end: /'''/, contains: [e.BACKSLASH_ESCAPE, n, a, i] },
                            { begin: /(fr|rf|f)"""/, end: /"""/, contains: [e.BACKSLASH_ESCAPE, n, a, i] },
                            { begin: /(u|r|ur)'/, end: /'/, relevance: 10 },
                            { begin: /(u|r|ur)"/, end: /"/, relevance: 10 },
                            { begin: /(b|br)'/, end: /'/ },
                            { begin: /(b|br)"/, end: /"/ },
                            { begin: /(fr|rf|f)'/, end: /'/, contains: [e.BACKSLASH_ESCAPE, a, i] },
                            { begin: /(fr|rf|f)"/, end: /"/, contains: [e.BACKSLASH_ESCAPE, a, i] },
                            e.APOS_STRING_MODE,
                            e.QUOTE_STRING_MODE,
                        ],
                ...
                a = {
                    ...
                    variants: [
                        ...
                        { begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, contains: ["self", n, o, r, e.HASH_COMMENT_MODE] },
                    ],
                };
                return (
                    (i.contains = [r, o, n]),
                    {
                        ...
                        contains: [
                            ...
                            e.HASH_COMMENT_MODE,
                            {
                                ...
                                illegal: /[${=;\n,]/,
                                contains: [e.UNDERSCORE_TITLE_MODE, a, { begin: /->/, endsWithParent: !0, keywords: "None" }],
                            },
        ...
        function (e, t) {
            ...
            e.exports = function (e) {
                var t = n,
                    ...
                    l = { $pattern: n, keyword: i.join(" "), literal: a.join(" "), built_in: r.join(" ") },
                    u = { className: "number", variants: [{ begin: "\\b(0[bB][01]+)n?" }, { begin: "\\b(0[oO][0-7]+)n?" }, { begin: e.C_NUMBER_RE + "n?" }], relevance: 0 },
                    d = { className: "subst", begin: "\\$\\{", end: "\\}", keywords: l, contains: [] },
                    f = { begin: "html`", end: "", starts: { end: "`", returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, d], subLanguage: "xml" } },
                    g = { begin: "css`", end: "", starts: { end: "`", returnEnd: !1, contains: [e.BACKSLASH_ESCAPE, d], subLanguage: "css" } },
                    p = { className: "string", begin: "`", end: "`", contains: [e.BACKSLASH_ESCAPE, d] };
                d.contains = [e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, f, g, p, u, e.REGEXP_MODE];
                var m = d.contains.concat([{ begin: /\(/, end: /\)/, contains: ["self"].concat(d.contains, [e.C_BLOCK_COMMENT_MODE, e.C_LINE_COMMENT_MODE]) }, e.C_BLOCK_COMMENT_MODE, e.C_LINE_COMMENT_MODE]);
                ...
                return {
                    ...
                    contains: [
                        ...
                        e.C_BLOCK_COMMENT_MODE,
                        u,
                        { begin: s(/[{,\n]\s*/, o(s(/(((\/\/.*$)|(\/\*(.|\n)*\*\/))\s*)*/, t + "\\s*:"))), relevance: 0, contains: [{ className: "attr", begin: t + o("\\s*:"), relevance: 0 }] },
                        {
                            ...
                            contains: [
                                ...
                                e.REGEXP_MODE,
                                {
                                    ...
                                    contains: [
                                        {
                                            className: "params",
                                            variants: [{ begin: e.UNDERSCORE_IDENT_RE }, { className: null, begin: /\(\s*\)/, skip: !0 }, { begin: /\(/, end: /\)/, excludeBegin: !0, excludeEnd: !0, keywords: l, contains: m }],
                                        },
                                    ],
                                },
                                { begin: /,/, relevance: 0 },
                        ...
                        { className: "function", beginKeywords: "function", end: /\{/, excludeEnd: !0, contains: [e.inherit(e.TITLE_MODE, { begin: t }), d], illegal: /\[|%/ },
                        { begin: /\$[(.]/ },
                        e.METHOD_GUARD,
                        ...
                        { begin: "(get|set)\\s+(?=" + t + "\\()", end: /{/, keywords: "get set", contains: [e.inherit(e.TITLE_MODE, { begin: t }), { begin: /\(\)/ }, d] },
                    ],
                    illegal: /#(?!!)/,
                };
            };
        ...
        function (e, t) {
            ...
            e.exports = function (e) {
                var t =
                    ...
                    n = { className: "meta", begin: "@" + "[À-ʸa-zA-Z_$][À-ʸa-zA-Z_$0-9]*", contains: [{ begin: /\(/, end: /\)/, contains: ["self"] }] },
                    o = function (e) {
                        return a("[", e, "]+([", e, "_]*[", e, "]+)?");
                    },
                    s = {
                    ...
                    contains: [
                        ...
                        { beginKeywords: "new throw return else", relevance: 0 },
                        {
                            ...
                            contains: [
                                ...
                                { className: "params", begin: /\(/, end: /\)/, keywords: t, relevance: 0, contains: [n, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, e.C_NUMBER_MODE, e.C_BLOCK_COMMENT_MODE] },
                                e.C_LINE_COMMENT_MODE,
                                e.C_BLOCK_COMMENT_MODE,
                            ],
                        },
        ...
        function (e, t, n) {
            ...
            e.exports = {
                mail: function (e) {
                    return { k: /^[A-Za-z0-9\u4e00-\u9fa5]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/.test(e), v: e };
                },
                link: function (e) {
                    return 0 < e.length && (e = /^(http|https)/.test(e) ? e : "http://".concat(e)), { k: !(0 < e.length) || /(http|https):\/\/[\w\-_]+(\.[\w\-_]+)+([\w\-\.,@?^=%&amp;:/~\+#]*[\w\-\@?^=%&amp;/~\+#])?/.test(e), v: e };
                },
            };
        },
        function (e, t, n) {
        ...
        function (e, t, n) {
            ...
            e.exports = function (e) {
                e.nestQuery = function (t) {
                    e.v.Query.doCloudQuery("select nick, comment, link, rid, isSpam, mailMd5, ua from Comment where rid in (".concat(JSON.stringify(t).replace(/(\[|\])/g, ""), ") order by -createdAt"))
                        .then(function (t) {
                        ...
                        e.loading.show(),
                            e.v.Query.doCloudQuery(
                                "select nick, comment, link, rid, isSpam, mailMd5, ua from Comment where (rid='' or rid is not exists) and url='"
                                    .concat(e.C.url, "' order by -createdAt limit ")
                                ...
                                .then(function (r) {
                                    ...
                                    if (o) {
                                        ...
                                        d &&
                                            i.default.on("click", d, function (n) {
        ...
        function (e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", { value: !0 }), (t.MathJaxSupport = void 0);
            var i,
        ...
        function (e, t, n) {
            "use strict";
            var i,
                a = (i = n(9)) && i.__esModule ? i : { default: i };
            e.exports = function (e) {
        ...
        function (e, t, n) {
            ...
            e.exports = function (e) {
                if (e.config.cloudflag)
                    try {
                        (e.cloudFlag = {}),
                            AV.Query.doCloudQuery("select * from Roles limit 100000000  order by -createdAt").then(
                                function (t) {
                                    e.cloudFlag.Roles = {};
                                    for (var n = 0; n < t.results.length; n++) e.cloudFlag.Roles[t.results[n].get("name")] = { nick: t.results[n].get("nick"), color: t.results[n].get("color") };
                                },
                                function (e) {
                                    console.log(e);
                                }
        ...
        function (e, t, n) {
            "use strict";
            var i,
                a = (i = n(4)) && i.__esModule ? i : { default: i };
            e.exports = function (e) {
                !(function (e) {
                    var t = document.querySelector(".leancloud-recent-comment");
                    t &&
                        !t.classList.contains("loaded") &&
                        AV.Query.doCloudQuery("select nick, mail, comment, url from Comment where (rid='' or rid is not exists) order by -createdAt limit 0,10").then(function (n) {
                            ...
                            if (i) {
                                for (var r = "", o = 0; o < i; o++)
                                    r +=
                                        ...
                                        n[o].get("nick") +
                                        " @ " +
                                        (0, a.default)(n[o].get("createdAt"), e.i18n) +
                                        "</span><span>" +
                                        n[o]
                                            .get("comment")
                                            .replace(/<[^>]+>/gi, "")
